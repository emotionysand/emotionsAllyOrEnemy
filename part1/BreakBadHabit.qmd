...
So, once we have set the problem, let's follow the lead.
...
::: {.callout-note}
## Execution is key
This idea is completely wrong. Execution, getting things done is not just tactics—it is a discipline and a system. It is the most important thing. It is not a goal. It is the now.
:::
